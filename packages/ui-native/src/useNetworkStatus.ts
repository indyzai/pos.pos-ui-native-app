...
let reachableSnapshot: boolean | undefined;
let checkingHealth = false;
let lastHealthCheck = 0;
const networkListeners = new Set<() => void>();
export const getNetworkStatusSnapshot = () => reachableSnapshot;
export const subscribeNetworkStatus = (listener: () => void) => {
...
export function useNetworkStatus(
    ...
    const initialStatus =
        browserOnline === false ? false : (reachableSnapshot ?? false);
