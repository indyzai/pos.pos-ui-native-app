...
import { useBottomNavigation } from "./BottomNavigationProvider";
import { useAppTheme } from "../theme/ThemeProvider";
import { AppPressable } from "../AppPressable";
import { BOTTOM_NAVIGATION_HEIGHT } from "./useBottomNavigationClearance";
...
export function BottomNavigation<Destination>({
    primaryItems,
    moreItems,
    trailingItem,
    isActive,
    ...
    primaryItems: readonly NavigationItemConfig<Destination>[];
    moreItems: readonly NavigationItemConfig<Destination>[];
    trailingItem?: NavigationItemConfig<Destination>;
}) {
        ...
        >
            <View style={s.items}>
                ...
                {trailingItem && (
                    <NavigationItem
                        {...trailingItem}
                        active={isActive(trailingItem.href)}
                        onPress={() => onNavigate(trailingItem.href)}
                    />
                )}
                <NavigationItem
                    label="More"
            ...
            <AppPressable
                accessibilityLabel={
                    centerItem?.label ?? "Center action unavailable"
                }
            ...
            >
                <View
                    style={[
                        ...
                        isDark && {
                            boxShadow: "0px 5px 14px rgba(0, 0, 0, 0.38)",
                        },
                    ]}
                >
                    <CenterIcon
                        size={27}
                        color={centerItem ? c.primary : c.textSecondary}
                        strokeWidth={2}
                    />
                    <Text
                        style={[
    ...
    return (
        ...
        >
            <View style={s.menuOverlay}>
                ...
                >
                    <View
                        style={[s.menuHandle, { backgroundColor: c.outline }]}
                    />
...
const s = StyleSheet.create({
    ...
    menuBackdrop: {
        ...
        backgroundColor: "rgba(12, 14, 19, 0.32)",
    },
    menuSheet: {
        minHeight: 330,
        padding: 16,
