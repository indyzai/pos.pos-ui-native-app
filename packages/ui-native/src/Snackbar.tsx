...
export function SnackbarProvider({
    ...
    const destructive = notification?.actions?.some(
        (action) => action.style === "destructive",
    );
    const success =
        /added|changed|cleared|completed|created|recorded|reconciled|saved|updated/i.test(
            notification?.title || "",
        );
                ...
                <View
                    ...
                    style={[
                        s.snackbar,
                        {
                            ...
                            boxShadow: "0px 8px 24px rgba(8, 12, 22, 0.22)",
                        },
                    ]}
                >
