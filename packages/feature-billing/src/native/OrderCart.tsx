        ...
        >
            <View {...headerPanResponder.panHandlers} style={s.head}>
                ...
                <View style={s.headActions}>
                    ...
                    >
                        <Text style={[s.closeText, { color: c.textSecondary }]}>
                            ×
                        </Text>
                    </AppPressable>
                </View>
            ...
            {innerContent ? (
                ...
                <>
                    {onSelectCustomer ? (
                        ...
                        >
                            ...
                            <View style={s.customerText}>
                                <Text
                                    numberOfLines={1}
                                    style={[s.customerName, { color: c.text }]}
                                >
                            ...
                            <Text
                                style={[s.changeCustomer, { color: c.primary }]}
                            >
                                Change
                            </Text>
                        </AppPressable>
                    ...
                    {items.length ? (
                        ...
                        <View
                            style={[s.empty, { borderColor: c.outlineMuted }]}
                        >
                            <Text>🛍</Text>
                            <Text
                                style={[
                    ...
                    >
                        {allowOrderDiscounts && items.length > 0 && (
                            <View style={s.orderDiscount}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(value) =>
                                        onOrderDiscount(Number(value) || 0)
                                    }
                                    keyboardType="decimal-pad"
                                    placeholder={formatCurrency(
                                        0,
                        ...
                        >
                            ...
                            <ArrowRight
                                size={21}
                                color={
                                    items.length ? c.primary : c.textSecondary
                                }
                                strokeWidth={2.7}
                            />
                        </AppPressable>
