        ...
        >
            <View style={[s.searchRow, isPhone && s.searchRowPhone]}>
                ...
                {(scanEnabled || onAddProduct || onToggleStats) && (
                    <View
                        style={[s.actionGroup, isPhone && s.actionGroupPhone]}
                    >
                        {scanEnabled && (
                            <AppPressable
                        ...
                        {onToggleStats ? (
                            ...
                            >
                                <BarChart3
                                    size={iconSize}
                                    color={statsVisible ? "#FFFFFF" : c.primary}
                                    strokeWidth={2.4}
                                />
                            </AppPressable>
                        ) : null}
