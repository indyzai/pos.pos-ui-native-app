    ...
    const panel = (
        ...
        >
                ...
                <View style={s.header}>
                    <View style={s.titleRow}>
                        ...
                        <Text style={[s.title, { color: c.text }]}>
                            Customer scrap exchange
                        </Text>
                    </View>
                    <AppPressable
                        accessibilityLabel={
                            embedded ? "Back to cart" : "Close scrap exchange"
                        }
                        onPress={onClose}
                    >
                        {embedded ? (
                            <ArrowLeft color={c.textSecondary} />
                        ) : (
            ...
            <Text style={[s.help, { color: c.textSecondary }]}>
                Record items received from the customer. Their value is settled
                against this bill.
            </Text>
            <ScrollView
            ...
            >
                {rows.map((row, index) => (
                    <View
                        ...
                        style={[s.row, { borderColor: c.outlineMuted }]}
                    >
                        <View style={s.name}>
                            <Text style={[s.product, { color: c.text }]}>
                                {row.product.name}
                            </Text>
                            <Text
                                style={[s.caption, { color: c.textSecondary }]}
                            >
                                Quantity × rate
                            </Text>
                        </View>
                ...
                {!loading && !products.length && (
                    <Text style={[s.empty, { color: c.textSecondary }]}>
                        Create products in a SCRAP category before accepting an
                        exchange.
                    </Text>
                )}
            </ScrollView>
            <View style={[s.footer, { borderTopColor: c.outlineMuted }]}>
                <View>
                    ...
                    <Text style={[s.total, { color: c.primary }]}>
