    ...
    return (
        ...
        >
            <Text style={[s.title, { color: c.text }]}>
                {category === "All" ? defaultTitle : category}
            </Text>
                        ...
                        >
                            ...
                            >
                                ...
                                !failedImages.has(product.id) ? (
                                    ...
                                    <ProductIcon
                                        iconKey={product.details?.iconKey}
                                        size={36}
                                    />
                                )}
                                <AppPressable
                            ...
                            {product.sku ? (
                                <Text
                                    numberOfLines={1}
                                    style={[s.sku, { color: c.textSecondary }]}
                                >
                                    SKU · {product.sku}
                                </Text>
                            ) : null}
                            ...
                            (product.details?.batchNumber ||
                                ...
                                <View style={s.pharmacyMeta}>
                                    ...
                                    {(pharmacyStatus.expired ||
                                        pharmacyStatus.expiringSoon) && (
                                        <AlertTriangle
                                            size={10}
                                            color={c.error}
                                        />
