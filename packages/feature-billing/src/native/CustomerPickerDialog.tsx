    ...
    const visibleCustomers = useMemo(() => {
        ...
        return term
            ? customers.filter((item) =>
                  [item.name, item.phone, item.email, item.gstin].some(
    ...
    const panel = (
        ...
        >
            ...
            <View
                style={[
                    s.search,
                    { backgroundColor: c.background, borderColor: c.outline },
                ]}
            >
            ...
            >
                ...
                {!visibleCustomers.length && (
                    <Text style={[s.empty, { color: c.textSecondary }]}>
                        No matching customers in local data.
                    </Text>
                )}
                {!!search.trim() &&
                    !customers.some(
...
const s = StyleSheet.create({
    ...
    backdrop: {
        ...
        backgroundColor: "rgba(8,12,22,.5)",
    },
    sheet: {
        maxHeight: "82%",
        minHeight: "55%",
