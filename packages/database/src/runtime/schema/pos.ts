...
const scopedEntity = (name: string) =>
    sqliteTable(
        name,
        {
            ...
            syncStatus: text("sync_status").notNull().default("API"),
...
export const stockCountLines = childEntity(
    "stock_count_lines",
    "stock_count_id",
);
...
export const purchaseOrderLines = childEntity(
    "purchase_order_lines",
    "purchase_order_id",
);
export const goodsReceipts = scopedEntity("goods_receipts");
export const goodsReceiptLines = childEntity(
    "goods_receipt_lines",
    "goods_receipt_id",
);

// Customer projections
export const customerAddresses = childEntity(
    "customer_addresses",
    "customer_id",
);
export const customerCreditSummaries = scopedEntity(
    "customer_credit_summaries",
);
export const customerLoyaltySummaries = scopedEntity(
...
export const serializedItemAssignments = scopedEntity(
...
export const syncOutbox = sqliteTable(
    ...
    (table) => [
        ...
        index("sync_outbox_scope_next_attempt_idx").on(
            table.scope,
            table.nextAttemptAt,
        ),
...
export const syncDependencies = sqliteTable(
    ...
    (table) => [
        index("sync_dependencies_job_idx").on(table.scope, table.jobId),
    ],
);
...
export const syncState = sqliteTable(
    ...
    (table) => [
        index("sync_state_scope_collection_idx").on(
            table.scope,
            table.collection,
        ),
    ],
