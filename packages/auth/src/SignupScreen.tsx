...
type Props = {
    onSignUp: (payload: RegistrationPayload) => Promise<void>;
    onLogin: () => void;
};
type Details = {
    name: string;
        ...
        const message =
            step === 0
                ...
                : !details.business ||
                  ...
                  : "";
        if (message) ui.showSnackbar("Check your details", message);
        return !message;
    };
    const proceed = async () => {
        if (step !== 2) {
            ...
            >
                ...
                >
                    ...
                    <Text style={[s.formNoteText, { color: c.text }]}>
                        Build a smarter business with IndyzAI POS
                    </Text>
                </View>
            </ScrollView>
        </View>
        ...
        <>
            <Text
                style={[
                    ...
                    {
                        color: c.text,
                        fontSize: Math.min(Math.max(size * 0.06, 23), 31),
                    },
                ]}
            >
                {heading}
