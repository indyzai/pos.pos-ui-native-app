...
export function AuthBranding({
        ...
        const header = (
            <>
                ...
                <View
                    style={[
                        s.mobileLayout,
                        isCompactLandscape && s.landscapeLayout,
                    ]}
                >
                    <BrandLockup compact />
                    <View
                        style={[
                            s.mobileCopy,
                            isCompactLandscape && s.landscapeCopy,
                        ]}
                    >
                        <Text
                            style={[
                                s.mobileTitle,
                                isCompactLandscape && s.landscapeTitle,
                            ]}
                        >
                            {title}
                        </Text>
                        <Text
                            style={[
                                s.mobileSubtitle,
                                isCompactLandscape && s.landscapeSubtitle,
                            ]}
                        >
                            {subtitle}
                        </Text>
    ...
    return (
        ...
        >
            ...
            <Text style={s.footer}>
                Made for the people building what’s next
            </Text>
        </LinearGradient>
    );
}
...
const s = StyleSheet.create({
    ...
    glowBottom: {
        ...
        left: -210,
        bottom: -100,
        backgroundColor: "rgba(196,181,253,.18)",
    },
    orb: {
        position: "absolute",
        borderRadius: 999,
