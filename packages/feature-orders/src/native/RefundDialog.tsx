...
} from "@indyzai/feature-orders/refundPolicy";
...
export function RefundDialog({
    ...
    const change = (productId: string, delta: number) => {
        ...
        setQuantities((current) => ({
            ...
            [productId]: Math.max(
                0,
                Math.min(maximum, (current[productId] || 0) + delta),
            ),
        }));
    };
    return (
                ...
                >
                    ...
                    >
                        {order.items.map((item) => {
                            const available = refundableQuantity(
                                order,
                                item.productId,
                                refunds,
                            );
                    ...
                    <AppPressable
                        ...
                        style={[
                            s.confirm,
                            {
                                ...
                                opacity: !selections.length || busy ? 0.5 : 1,
                            },
                        ]}
                    >
...
const s = StyleSheet.create({
    ...
    backdrop: {
        ...
        backgroundColor: "rgba(10,15,25,.56)",
    },
    sheet: {
        maxHeight: "86%",
