import { kvStore as defaultKvStore } from '@indyzai/pos-core/storage';
import { development as defaultDev, env as defaultEnv, productionApiUrls as defaultProdUrls } from '@indyzai/pos-core/env';
