...
import {
    ...
    productIconOptions,
    type ProductIconKey,
} from "@indyzai/feature-billing/product-icons";
...
export function AddInventoryItemModal({
    ...
    const save = async () => {
        ...
        if (
            ...
            showSnackbar(
                "Invalid item",
                "Enter valid prices and stock quantities, then select a category.",
            );
            return;
        }
        await onSave({
    ...
    const content = (
        <AppPaperProvider>
            <AppKeyboardSafeView
                style={[s.overlay, embedded && s.embeddedOverlay]}
            >
                {!embedded ? (
                    <AppPressable
                        style={s.backdrop}
                ...
                >
                        ...
                        <View style={s.header}>
                            <View style={s.heading}>
                                ...
                                {quickAdd ? (
                                    ...
                                    >
                                        Add the essentials now. Complete this
                                        product later from Inventory.
                                    </Text>
                                ) : null}
                            </View>
                            <AppPressable
                    ...
                    >
                        ...
                        <AppDropdown
                            label="Category"
                            value={categoryId}
                            options={references.categories.map((x) => ({
                                value: x.id,
                                label: x.name,
                            }))}
                            loading={loading}
