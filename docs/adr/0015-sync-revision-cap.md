...
OpenPOS uses per-entity `rev` values to break otherwise ambiguous sync conflicts. Revisions are stored in JSON snapshots and can pass through JavaScript, SQLite, and platform bridges.
