...
After more real-world sync traffic, that rule proved too aggressive around close-together edits and clock-skewed devices. OpenPOS 0.8.2 changed the shipped behavior and release notes to prefer live data in ambiguous delete-vs-live merges.
