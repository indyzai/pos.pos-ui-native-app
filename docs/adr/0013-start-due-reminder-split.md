...
OpenPOS tasks can have a start time and a due date. These fields answer different GTD questions:
...
OpenPOS keeps start reminders and due reminders as separate notification settings and scheduling keys.
