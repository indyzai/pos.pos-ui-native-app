...
- Added Android Quick Settings capture and assistant/App Actions capture routing through `CREATE_NOTE` and `openpos:///capture` deep links.
...
- Replaced native-looking confirmation alerts with OpenPOS-themed alerts.
