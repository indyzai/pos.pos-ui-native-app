...
- OmniFocus import is more complete: OpenPOS now accepts JSON and ZIP exports, maps OmniFocus folders into areas, preserves supported repeat rules, and turns nested tasks into checklist items when possible.
