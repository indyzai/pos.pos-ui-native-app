...
- Let mobile users choose the calendar push target and prevented desktop calendar imports from echoing OpenPOS mirror calendars back into the app.
...
- fix(calendar): ignore OpenPOS mirror calendars on desktop
