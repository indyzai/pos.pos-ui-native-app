...
- Decoded gzip ICS subscriptions and removed OpenPOS's title prefix from exported calendar items.
...
- Deleted orphaned OpenPOS calendars more reliably.
...
- fix(mobile): delete orphaned OpenPOS calendars
