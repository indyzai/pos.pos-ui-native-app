...
This is the third release candidate for OpenPOS 1.1.0. Use it for tester channels only. Prepare final stable `1.1.0` notes separately when the stable release is cut.
