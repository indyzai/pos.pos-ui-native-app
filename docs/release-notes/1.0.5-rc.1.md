...
This is the first release candidate for OpenPOS 1.0.5. It is for tester channels; the final stable `1.0.5` notes should be prepared separately when the stable release is cut.
...
- Reflected OpenPOS calendar color changes in external Android calendar apps.
...
- fix(mobile): reflect OpenPOS calendar color change in external Android apps (#726)
...
- docs: point OpenPOS docs to public site
- docs: point OpenPOS docs to public sources
