...
Tauri v2 desktop app for the OpenPOS productivity system.
...
Windows release builds also publish `openpos_<version>_windows_x64_portable.zip`.
Extract it to a writable folder and keep `portable.txt` next to `openpos.exe`.
...
- **Portable data**: `profile/data/openpos.db`, `profile/data/data.json`, logs, snapshots, and audio captures
...
- **Cloud** - Self-hosted cloud backend (see https://docs.openpos.app/data-sync/ and https://docs.openpos.app/data-sync/cloud-deployment)
