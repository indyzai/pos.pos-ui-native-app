...
const CHOCOLATEY_PACKAGE_API =
  "https://community.chocolatey.org/api/v2/Packages()?$filter=Id%20eq%20%27openpos%27%20and%20IsLatestVersion";
const CHOCOLATEY_PACKAGE_URL =
  "https://community.chocolatey.org/packages/openpos";
const AUR_SOURCE_RPC_API =
  "https://aur.archlinux.org/rpc/?v=5&type=info&arg%5B%5D=openpos";
const AUR_SOURCE_PACKAGE_URL = "https://aur.archlinux.org/packages/openpos";
...
const fetchChocolateyLatestVersion = async (): Promise<SourceVersionResult> => {
  ...
  const match = payload.match(/Packages\(Id='openpos',Version='([^']+)'\)/i);
