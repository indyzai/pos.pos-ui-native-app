...
export { hasPendingSyncSideEffects } from '@openpos/core';
export type { FastSyncState } from '@openpos/core';

const FAST_SYNC_STATE_KEY = 'openpos-fast-sync-state-v1';
const LOCAL_SYNC_STATUS_KEY = 'openpos-local-sync-status-v1';
