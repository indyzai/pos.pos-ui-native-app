import type { AppearanceSettings } from '@openpos/core';

export type DesktopTextSizeMode = NonNullable<AppearanceSettings['textSize']>;

export const TEXT_SIZE_STORAGE_KEY = 'openpos-text-size';
...
export function applyDesktopTextSize(mode: DesktopTextSizeMode): void {
    ...
    root.style.setProperty('--openpos-text-scale', TEXT_SCALE_BY_MODE[mode]);
}
