export const CALENDAR_TASK_DRAG_MIME = 'application/x-openpos-task-id';
export const CALENDAR_TASK_DRAG_KIND_MIME = 'application/x-openpos-calendar-item-kind';

const CALENDAR_TASK_DRAG_TEXT_PREFIX = 'openpos-task:';
const CALENDAR_TASK_DRAG_PREVIEW_CLASS = 'openpos-calendar-drag-preview';
