...
const managedDirPrefix = 'C:/Users/me/AppData/Roaming/openpos/attachments/';
...
describe('isBareFileReference', () => {
    it('flags file attachments pointing outside the managed attachments dir with no cloud copy', () => {
        ...
        expect(isBareFileReference(
            { kind: 'file', uri: 'C:\\Users\\me\\AppData\\Roaming\\openpos\\attachments-old\\id.pdf' },
            managedDirPrefix,
        )).toBe(true);
    });
    ...
    it('treats managed copies, synced files, links, and remote uris as owned', () => {
        expect(isBareFileReference(
            { kind: 'file', uri: 'C:\\Users\\me\\AppData\\Roaming\\openpos\\attachments\\id.pdf' },
            managedDirPrefix,
        )).toBe(false);
        expect(isBareFileReference(
