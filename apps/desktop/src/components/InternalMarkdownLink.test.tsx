...
describe('InternalMarkdownLink', () => {
    ...
    it('restores deleted task links and navigates to the live task view', async () => {
        ...
        try {
            const { getByRole, getByText } = render(
                <LanguageProvider>
                    <InternalMarkdownLink href="openpos://task/task-1" linkContext={currentLinkContext()}>Deleted task</InternalMarkdownLink>
                </LanguageProvider>
            );
    ...
    it('restores deleted project links and opens the projects view', async () => {
        ...
        try {
            const { getByRole, getByText } = render(
                <LanguageProvider>
                    <InternalMarkdownLink href="openpos://project/project-1" linkContext={currentLinkContext()}>Deleted project</InternalMarkdownLink>
                </LanguageProvider>
            );
