...
import { useTaskStore, type Area, type Project } from '@openpos/core';
...
describe('ProjectsView', () => {
    ...
    it('allows keyboard resizing of the projects sidebar and persists the width', async () => {
        ...
        await waitFor(() => {
            expect(window.localStorage.getItem('openpos:projects:sidebarWidth')).toBe('328');
        });
    ...
    it('collapses and restores the projects sidebar panel', async () => {
        ...
        expect(window.localStorage.getItem('openpos:view:projects:v1')).toContain('"projectsSidebarCollapsed":true');
