import type { AIProviderId, AIReasoningEffort, AiSettings } from '@openpos/core';
import { formatOpenAIExtraBodyParams, parseOpenAIExtraBodyParamsInput } from '@openpos/core';
