...
const t = {
    ...
    speechParakeetModelDesc: 'Download once to install the Parakeet ASR model for local transcription. Model weights are not bundled with OpenPOS.',
...
describe('SettingsAiPage', () => {
    ...
    it('shows Parakeet download progress while installing the local model', () => {
        const { getByRole, getByText } = render(
            <SettingsAiPage
                ...
                speechOfflineModelPath="/home/dd/.local/share/openpos/parakeet-model"
    ...
    it('offers one-click Parakeet model download from the offline model card', () => {
        ...
        fireEvent.click(getByRole('button', { name: /Speech to text/i }));
        expect(getByDisplayValue('/home/dd/.local/share/openpos/parakeet-model')).toBeInTheDocument();
