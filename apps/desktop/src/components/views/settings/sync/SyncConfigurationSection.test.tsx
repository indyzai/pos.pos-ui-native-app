...
const baseProps: Parameters<typeof SyncConfigurationSection>[0] = {
    t: {
        ...
        syncBackendGroupCloudDesc: 'Easy account sync handled by OpenPOS.',
        ...
        syncBackendGroupAdvancedDesc: 'Use WebDAV or your own OpenPOS Cloud endpoint.',
...
describe('SyncConfigurationSection', () => {
    ...
    it('shows Dropbox as a first-level sync backend without the nested cloud provider picker', () => {
        ...
        expect(queryByText('Easy account sync handled by OpenPOS.')).toBeInTheDocument();
    ...
    it('shows the selected backend group instead of all groups at once', () => {
        ...
        expect(queryByText('Use WebDAV or your own OpenPOS Cloud endpoint.')).toBeInTheDocument();
