...
import { BOTTOM_NAVIGATION_HEIGHT } from '@indyzai/pos-ui-native';
import {
...
export function BottomNavigation() {
    ...
    const primaryItems = navigationItemsForRole(primaryNavigationItems, role, flags);
    const moreItems = navigationItemsForRole(moreNavigationItems, role, flags);
