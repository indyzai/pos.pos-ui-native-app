...
export function LoginScreen({
    ...
    return (
        <View style={[s.screen, !wideLayout && s.singleColumn, { backgroundColor: c.background }]}>
            <AuthBranding
                title="IndyzAI POS Admin"
                subtitle="Manage your organization, users, inventory, and operations."
            ...
            >
                ...
                >
                    <Text
                        style={[
                            s.title,
                            { color: c.text, fontSize: Math.min(Math.max(width * 0.06, 24), 32) },
                        ]}
                    >
                        Welcome back
                    </Text>
                ...
                <View style={[s.formNote, { backgroundColor: c.surface, borderColor: c.outlineMuted }]}>
                    ...
                    <Text style={[s.formNoteText, { color: c.text }]}>
                        Secure administrator access for your IndyzAI POS workspace
                    </Text>
                </View>
            </ScrollView>
        </View>
