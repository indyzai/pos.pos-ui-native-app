...
export function PettyCashDialog({
    ...
    const panel = (
        <View
            style={[s.dialog, embedded && s.embedded, { backgroundColor: c.surface, borderColor: c.outline }]}
        >
            {!embedded && (
                <View style={s.header}>
            ...
            >
                ...
                <AppPressable
                    ...
                    onPress={() =>
                        void onSave({ type, amount: value, description: description.trim() || undefined })
                    }
                    style={[
                        s.save,
                        {
...
function TypeButton({
    ...
    return (
        <AppPressable
            onPress={onPress}
            style={[s.type, { backgroundColor: active ? c.surface : 'transparent' }]}
        >
