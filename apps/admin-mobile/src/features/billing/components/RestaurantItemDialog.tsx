        ...
        <Modal transparent visible={!!product} animationType="slide" onRequestClose={onClose}>
            <AppKeyboardSafeView style={s.overlay}>
                ...
                <View style={[s.sheet, { backgroundColor: c.surface }]}>
                    ...
                    >
                        {modifiers.length > 0 && (
                            <Text style={[s.label, { color: c.textSecondary }]}>Options</Text>
                        )}
                        {modifiers.length > 0 && (
                            <View style={s.options}>
                                {modifiers.map((item) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <Text
                                                style={[s.optionText, { color: active ? c.primary : c.text }]}
                                            >
                                                {item.label}
                                                {item.price
                    ...
                    >
                        <Text style={s.addText}>
                            Add {quantity} ·{' '}
                            {formatCurrency(((product?.price || 0) + adjustment) * quantity, currencyCode)}
                        </Text>
                    </AppPressable>
                </View>
            </AppKeyboardSafeView>
