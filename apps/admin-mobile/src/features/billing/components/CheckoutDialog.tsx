                    ...
                    {method === 'CASH' ? (
                        <View>
                            ...
                            <View
                                style={[
                                    s.changeRow,
                                    { backgroundColor: cashShort ? c.errorSoft : c.surfaceMuted },
                                ]}
                            >
                                <Text
                                    style={[s.changeLabel, { color: cashShort ? c.error : c.textSecondary }]}
                                >
                        ...
                        <View>
                            {method === 'CARD' && (
                                <>
                                    ...
                                    <TextInput
                                        value={cardLast4}
                                        onChangeText={(value) =>
                                            setCardLast4(value.replace(/\D/g, '').slice(0, 4))
                                        }
                                        ...
                                        {selectedMethod.bankAccounts
                                            ...
                                            .map((account) => (
                                                ...
                                                >
                                                    ...
                                                    <Text
                                                        numberOfLines={1}
                                                        style={[s.accountMeta, { color: c.textSecondary }]}
                                                    >
                            ...
                            {upiPaymentUri && (
                                <View style={[s.qrCard, { backgroundColor: c.surfaceMuted }]}>
                                    ...
                                    <Text style={[s.qrTitle, { color: c.text }]}>
