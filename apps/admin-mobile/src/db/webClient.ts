...
export async function writeWebBillingSnapshot(scope: string, snapshot: BillingSnapshot): Promise<void> {
    ...
    await new Promise<void>((resolve, reject) => {
        ...
        transaction.onerror = () =>
            reject(transaction.error ?? new Error('Unable to write browser storage.'));
        transaction.onabort = () =>
            reject(transaction.error ?? new Error('Browser storage write was aborted.'));
...
export async function clearWebLocalData(): Promise<void> {
    ...
    await new Promise<void>((resolve, reject) => {
        ...
        transaction.onerror = () =>
            reject(transaction.error ?? new Error('Unable to clear browser storage.'));
        transaction.onabort = () =>
