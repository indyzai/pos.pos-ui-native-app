...
export function AppHeader({
    ...
    const handleDebugUser = async () => {
        ...
        showSnackbar(
            'Debug user',
            storedUser ? JSON.stringify(storedUser, null, 2) : 'No stored user found.',
        );
    };
                ...
                <View style={[s.brandCopy, isPhone ? s.phoneBrandCopy : s.desktopBrandCopy]}>
                        ...
                        <View style={s.titleRow}>
                            ...
                            {Boolean(businessName) && (
                                ...
                                >
                                    ...
                                    <Text
                                        numberOfLines={1}
                                        style={[s.businessTagText, { color: themeColors.primary }]}
                                    >
                                        {businessName}
                                    </Text>
                                </View>
                    ...
                    <View style={s.branchRow}>
                        ...
                        <AppPressable
                            ...
                            onPress={() =>
                                isCounterOpen ? setSessionSummaryOpen(true) : setCounterOpen(true)
                            }
                            style={[
                                s.counterStatus,
                        ...
                        >
                            ...
                            <Text
                                numberOfLines={1}
                                style={[s.counterStatusText, { color: counterColors.text }]}
                            >
                                {isPhone
                                    ? isCounterOpen
                                        ? 'Open'
