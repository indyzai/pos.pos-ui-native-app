...
const SHORTCUTS_RESOURCE = '@xml/openpos_shortcuts';
const SHORTCUTS_FILE_NAME = 'openpos_shortcuts.xml';
const SHORTCUTS_STRINGS_FILE_NAME = 'openpos_shortcuts_strings.xml';
...
<shortcuts xmlns:android="http://schemas.android.com/apk/res/android">
  <capability android:name="actions.intent.CREATE_THING">
    <intent android:action="android.intent.action.VIEW">
      <url-template android:value="openpos:///capture{?title,note}" />
      <parameter
    ...
    <intent android:action="android.intent.action.VIEW">
      <url-template android:value="openpos:///capture" />
    </intent>
  </capability>

  <capability android:name="actions.intent.GET_THING">
    <intent android:action="android.intent.action.VIEW">
      <url-template android:value="openpos:///global-search{?q}" />
      <parameter
        android:name="thing.name"
        android:key="q"
        android:required="true" />
    ...
    <intent android:action="android.intent.action.VIEW">
      <url-template android:value="openpos:///global-search" />
    </intent>
  </capability>

  <capability android:name="actions.intent.OPEN_APP_FEATURE">
    <intent android:action="android.intent.action.VIEW">
      <url-template android:value="openpos:///open-feature{?feature}" />
      <parameter
    ...
    <intent android:action="android.intent.action.VIEW">
      <url-template android:value="openpos:///inbox" />
    </intent>
  </capability>
  ...
  <shortcut
    ...
    <intent
      ...
      android:data="openpos:///capture-quick?mode=text" />
  </shortcut>
  <shortcut
    android:enabled="true"
    android:icon="@mipmap/ic_launcher"
