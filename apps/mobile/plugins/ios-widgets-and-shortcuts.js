...
const TARGET_NAME = 'OpenPOSWidgets';
const WIDGETS_FOLDER = 'widgets-ios';
const APP_INTENTS_FOLDER = 'ios-app-intents';
const APP_GROUP = 'group.com.indyzai.pos.openpos';
const SHORTCUT_URL_KEY = 'url';
const SIRI_CAPTURE_SHORTCUTS_PROVIDER = 'OpenPOSSiriCaptureShortcuts';
const SPOTLIGHT_INDEXER = 'OpenPOSShortcutsSpotlightIndexer';
const SHORTCUT_ITEMS = [
  {
    UIApplicationShortcutItemType: 'com.indyzai.pos.openpos.add_task',
    ...
    UIApplicationShortcutItemUserInfo: { [SHORTCUT_URL_KEY]: 'openpos:///capture-quick?mode=text' },
  },
  {
    UIApplicationShortcutItemType: 'com.indyzai.pos.openpos.open_focus',
    ...
    UIApplicationShortcutItemUserInfo: { [SHORTCUT_URL_KEY]: 'openpos:///focus' },
  },
  {
    UIApplicationShortcutItemType: 'com.indyzai.pos.openpos.open_calendar',
    ...
    UIApplicationShortcutItemUserInfo: { [SHORTCUT_URL_KEY]: 'openpos:///calendar' },
  },
];
...
const addWidgetTargetToXcode = (config) =>
  withXcodeProject(config, (cfg) => {
    ...
    const runnerBundleId = cfg.ios?.bundleIdentifier || 'com.indyzai.pos.openpos';
...
function withIosWidgetsAndShortcuts(config) {
  ...
  const bundleIdentifier = `${config.ios?.bundleIdentifier || 'com.indyzai.pos.openpos'}.${TARGET_NAME}`;
  const appExtensions =
