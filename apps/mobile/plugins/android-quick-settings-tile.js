...
const CAPTURE_URI = 'openpos:///capture-quick?mode=text';
...
const STRINGS_FILE_NAME = 'openpos_quick_settings_tile_strings.xml';
...
<resources>
  ...
  <string name="quick_settings_capture_tile_description" translatable="false">Open OpenPOS quick capture</string>
</resources>
`;
