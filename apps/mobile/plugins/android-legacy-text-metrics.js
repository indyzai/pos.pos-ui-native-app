...
const TEXT_VIEW_STYLE = { name: 'OpenPOS.TextView', parent: 'Widget.AppCompat.TextView' };
const EDIT_TEXT_STYLE = { name: 'OpenPOS.EditText', parent: 'Widget.AppCompat.EditText' };
...
module.exports = createRunOncePlugin(
  ...
  'openpos-android-legacy-text-metrics',
  '1.0.0',
);
