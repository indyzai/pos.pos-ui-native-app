package com.indyzai.pos.openpos.notificationopenintents
...
object PersistentCaptureNotifier {
  const val CHANNEL_ID = "openpos-persistent-capture"
  ...
  private const val CAPTURE_URI = "openpos:///capture-quick?mode=text"
  private const val CONTENT_REQUEST_CODE = NOTIFICATION_ID
  private const val DISMISS_REQUEST_CODE = NOTIFICATION_ID + 1

  const val EXTRA_TITLE = "com.indyzai.pos.openpos.persistentCapture.title"
  const val EXTRA_TEXT = "com.indyzai.pos.openpos.persistentCapture.text"
  const val EXTRA_CHANNEL_NAME = "com.indyzai.pos.openpos.persistentCapture.channelName"
  ...
  // dismiss intent (#819).
  private const val PREFS_NAME = "openpos-persistent-capture"
