...
final class CloudKitSyncManager {
    ...
    let containerID = "iCloud.com.indyzai.pos.openpos"
    let zoneName = "OpenPOSZone"
    let subscriptionID = "OpenPOSZoneSubscription"
    ...
    func saveRecords(
        ...
        for batchStart in stride(from: 0, to: recordsToSave.count, by: saveBatchSize) {
            ...
            let cbQueue = DispatchQueue(label: "com.indyzai.pos.openpos.savecb")
    ...
    private func fetchRecordsByID(_ ids: [CKRecord.ID]) async throws -> [CKRecord.ID: CKRecord] {
        ...
        let cbQueue = DispatchQueue(label: "com.indyzai.pos.openpos.fetchcb")
    ...
    func deleteRecords(recordType: String, recordIDs: [String]) async throws {
        ...
        for batchStart in stride(from: 0, to: ckIDs.count, by: batchSize) {
            ...
            op.qualityOfService = .utility
            let cbQueue = DispatchQueue(label: "com.indyzai.pos.openpos.deletecb")
