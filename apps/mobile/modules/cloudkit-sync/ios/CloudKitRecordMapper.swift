...
enum CloudKitRecordMapper {
    ...
    static let taskType = "OpenPOSTask"
    static let projectType = "OpenPOSProject"
    static let sectionType = "OpenPOSSection"
    static let areaType = "OpenPOSArea"
    static let personType = "OpenPOSPerson"
    static let settingsType = "OpenPOSSettings"
    ...
    private static let taskFieldSpecs: [FieldSpec] = [
        ...
        FieldSpec(jsKey: "suppressOpenPOSReminders", ckKey: "suppressOpenPOSReminders", kind: .bool),
