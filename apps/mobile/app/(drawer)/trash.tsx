...
import { buildTrashTimeline, getInlineMarkdownPreview, projectMatchesAreaFilterSelection, shallow, taskMatchesAreaFilterSelection, tFallback, useTaskStore } from '@openpos/core';
import type { Project, StoreActionResult, Task } from '@openpos/core';
