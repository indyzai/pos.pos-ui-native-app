...
import { getDefaultTaskAreaMode, useTaskStore, type MobileQuickAccessView, type SavedSearch, type Task } from '@openpos/core';
import {
...
export default function TabLayout() {
  ...
  // Material 3: capture is OpenPOS's most important action, so the FAB uses the
