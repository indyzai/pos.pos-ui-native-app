...
import { configureDateFormatting, type Task } from '@openpos/core';
...
const t = (key: string) => ({
    ...
    'taskEdit.suppressOpenPOSRemindersHint': 'Skip start and due reminders for this task. It still appears in Focus and your lists.',
...
describe('TaskEditScheduleField', () => {
    ...
    it('shows the calendar reminder handoff once on the due-date field for explicit reminder times', () => {
        ...
        expect(setDraftField).toHaveBeenCalledWith('suppressOpenPOSReminders', true);
    });
