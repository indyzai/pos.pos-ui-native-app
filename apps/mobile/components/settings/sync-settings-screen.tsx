...
const DATA_AND_SYNC_GUIDE_URL = 'https://docs.openpos.app/data-sync/';
const IMPORT_GUIDE_URL = 'https://docs.openpos.app/import/';
...
function SyncSettingsView({
    ...
    const handleClearPendingRemoteDeletes = useCallback(() => {
        ...
        Alert.alert(
            ...
            tr('settings.syncMobile.onlyClearTheseIfYouNoLongerWantOpenPOSTo'),
            [
    ...
    // Encryption covers the backends OpenPOS writes whole blobs to; the self-hosted
                ...
                {mode === 'sync' ? (
                    ...
                    <>
                        <SyncBackupSection
                            ...
                            handleImportOpenPOSCsv={() => void handleImportOpenPOSCsv()}
