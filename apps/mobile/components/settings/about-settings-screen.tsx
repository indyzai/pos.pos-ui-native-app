...
import { submitFeedbackSubmission } from '@openpos/core';
...
export function AboutSettingsScreen({
    ...
    const appName = Constants.expoConfig?.name || Application.applicationName || 'OpenPOS';
    ...
    const APP_STORE_BUNDLE_ID = Constants.expoConfig?.ios?.bundleIdentifier || Application.applicationId || 'com.indyzai.pos.openpos';
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: tc.bg }]} edges={['bottom']}>
            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={scrollContentStyle}>
                <View style={[styles.settingCard, { backgroundColor: tc.cardBg }]}>
                    ...
                    <TouchableOpacity
                        style={[styles.settingRow, { borderTopWidth: 1, borderTopColor: tc.border }]}
                        onPress={() => openLink('https://docs.openpos.app')}
                    >
                    ...
                    <TouchableOpacity
                        style={[styles.settingRow, { borderTopWidth: 1, borderTopColor: tc.border }]}
                        onPress={() => openLink('https://openpos.app/privacy')}
                    >
                        <Text style={[styles.settingLabel, { color: tc.text }]}>{t('settings.privacy')}</Text>
                        <Text style={styles.linkText}>openpos.app/privacy</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={[styles.settingRow, { borderTopWidth: 1, borderTopColor: tc.border }]}
                    ...
                    <TouchableOpacity
                        style={[styles.settingRow, { borderTopWidth: 1, borderTopColor: tc.border }]}
                        onPress={() => openLink('https://openpos.app/donate?src=app_about')}
                    >
