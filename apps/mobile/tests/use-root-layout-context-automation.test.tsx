...
describe('useRootLayoutContextAutomation', () => {
  ...
  it('notifies for context activation URLs without navigating the app shell', async () => {
    ...
    await act(async () => {
      create(
        <TestHarness
          incomingUrl="openpos://contexts?token=%40parents&contextAction=activate"
  ...
  it('handles deactivation URLs silently', async () => {
    ...
    await act(async () => {
      create(
        <TestHarness
          incomingUrl="openpos:///context/deactivate/parents"
          returnToBackground={returnToBackground}
        />
      );
    });
  ...
  it('uses localized notification templates for context activation', async () => {
    ...
    await act(async () => {
      create(
        <TestHarness
          incomingUrl="openpos://contexts?token=%40family&contextAction=activate"
          returnToBackground={returnToBackground}
