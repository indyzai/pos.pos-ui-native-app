...
const sale = (id, session, amount = 100) => ({
  id, billId: `B-${id}`, counterSessionId: session, saleDate: '2026-09-13T10:00:00.000Z',
  status: 'COMPLETED', totalAmount: amount, taxAmount: 5, paymentMethod: 'CASH', items: [],
});
...
describe('POS reports', () => {
  ...
  it('calculates totals from only the supplied visible sales', () => {
    const metrics = buildReportMetrics([sale('1', 'session-a', 125)], [], 1, new Date('2026-09-13T12:00:00.000Z'));
