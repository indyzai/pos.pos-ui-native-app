...
class FallbackURL {
    ...
    // base resolution for expo-router (`new URL('/focus', 'file:')` became
    ...
    static createObjectURL() {
        void logWarn('[OpenPOS] URL.createObjectURL called but not supported by shim. Returning empty string to prevent crash.', {
            scope: 'polyfill',
        });
        return '';
    }
