...
ADB_BIN="${ADB_BIN:-adb}"
PACKAGE="${PACKAGE:-com.indyzai.pos.openpos}"
ACTIVITY="${ACTIVITY:-.MainActivity}"
MODE="${MODE:-cold}"
RUNS="${RUNS:-10}"
WAIT_MS="${WAIT_MS:-3500}"
REQUIRED_JS_MARKER="${REQUIRED_JS_MARKER:-js.splash_hidden}"
LOGCAT_SPECS="${LOGCAT_SPECS:-OpenPOSStartup:I ReactNativeJS:I LOG_FLOWCTRL:W AndroidRuntime:E Expo:E System.err:W *:S}"
