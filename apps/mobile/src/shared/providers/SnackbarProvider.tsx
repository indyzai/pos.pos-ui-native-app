        ...
        >
          ...
          <View style={s.copy}>
            ...
            {notification.message ? (
              <Text style={[s.message, { color: c.textSecondary }]}>{notification.message}</Text>
            ) : null}
            {notification.actions?.length ? (
              <View style={s.actions}>
                {notification.actions.map((action, index) => (
                  ...
                  >
                    <Text
                      style={[s.actionText, { color: action.style === 'destructive' ? c.error : c.primary }]}
                    >
                      {action.text}
                    </Text>
                  </AppPressable>
          ...
          <AppPressable accessibilityLabel="Dismiss notification" onPress={dismiss} style={s.dismiss}>
