      ...
      ? [
          {
            ...
            ...(checkoutPayment.referenceNumber ? { referenceNumber: checkoutPayment.referenceNumber } : {}),
            ...(checkoutPayment.bankAccountId ? { bankAccountId: checkoutPayment.bankAccountId } : {}),
          },
        ]
      : []),
  ];
