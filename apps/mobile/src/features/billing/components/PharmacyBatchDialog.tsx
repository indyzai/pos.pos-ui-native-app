    ...
    onAdd(
      {
        ...
        details: {
          ...
          prescriptionRequired: selected.prescriptionRequired ?? product.details?.prescriptionRequired,
        },
      },
      {
              ...
              return (
                ...
                >
                  <View style={s.batchTop}>
                    <Text style={[s.batchNumber, { color: c.text }]}>{batch.batchNumber}</Text>
                    {active ? (
                  ...
                  <View style={s.metaRow}>
                    <CalendarDays
                      size={12}
                      color={status.expired || status.expiringSoon ? c.error : c.textSecondary}
                    />
                    <Text
                      style={[
                        s.meta,
                    ...
                    >
                      {batch.expiryDate || 'Expiry not configured'} · {batch.stock} available
                    </Text>
