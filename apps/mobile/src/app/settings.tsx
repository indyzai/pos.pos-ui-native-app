      ...
      <KeyboardAvoidingView style={s.flex} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        ...
        >
          <View style={[s.card, { backgroundColor: c.surface, borderColor: c.outlineMuted }]}>
            ...
            {section === 'features' ? <BillingSettingsSection registerSave={registerSave} /> : null}
...
const s = StyleSheet.create({
  ...
  titleRow: { marginBottom: 4, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
