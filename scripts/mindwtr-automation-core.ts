...
import { createOpenPOSAutomationStorage } from './openpos-automation-storage';
...
export async function createOpenPOSAutomationService(options: AutomationServiceOptions = {}) {
    const storage = createOpenPOSAutomationStorage(options);
