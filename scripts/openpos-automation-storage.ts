...
import { resolveOpenPOSStoragePaths } from './openpos-paths';
...
export function createOpenPOSAutomationStorage(options: AutomationStorageOptions = {}): AutomationStorage {
    const paths = resolveOpenPOSStoragePaths(options);
